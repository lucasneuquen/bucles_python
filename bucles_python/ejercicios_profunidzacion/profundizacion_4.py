...
for x in temp_dataloger:
    ...
    if x<temperatura_min:
        temperatura_min=x
    temperatura_sumatoria=temperatura_sumatoria+x
...
print('*Temperatura Promedio: ', f"{temperatura_promedio:.2f}")
print('*Total de temperaturas: ', temperatura_len)
...
print('Según los registros, nos encontramos en: ',estacion)
print('******')
print('analisis finalizado :)')
print('******')

print('valores obtenidos con función max, min y sum')
print('********************************************')
valor=sum(temp_dataloger)
print('Total de temperaturas: ',valor, '. Diferencia con cálculo anterior: ', temperatura_sumatoria-valor)
temp_max=max(temp_dataloger)
print('Temperatura Máxima: ',temp_max, '. Diferencia con cálculo anterior: ', temperatura_max-temp_max)
temp_min=min(temp_dataloger)
print('Temperatura Mínima: ',temp_min, '. Diferencia con cálculo anterior: ', temperatura_min-temp_min)
